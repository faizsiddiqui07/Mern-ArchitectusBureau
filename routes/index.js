...
const { getProjectController, getWebsiteProjectController, getSingleProjectController } = require("../controller/projects/getProject")
...
router.get('/api/projectDetails/:slug', getSingleProjectController)
